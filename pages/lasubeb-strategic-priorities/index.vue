...
<section id="feature-section" data-w-id="5140f89c-d73a-5b04-4de6-765fd78f9495" class="feature-section">
    <div class="flex-container w-container">
      ...
      <div class="page-img-mask"><img src="../../assets/images/lasubeb_priorities.jpg" alt="LASUBEB Pillars" height="" class="feature-image-priorities"></div>
      <div class="page-content-block">
        <p class="paragraph-2">The Strategic Priorities represent specific initiatives which, when fully implemented, will facilitate successful implementation of <strong>EKO EXCEL</strong>, Lagos State’s flagship educational programme initiated by <strong>Governor Babajide Sanwo-Olu.</strong></p>
      </div>
